...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'php_bboauth_tokens', 'php_bboauth_states', 'php_bboauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'php_bbusers', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'php_bbconfig');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'php_bbconfig_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'php_bbforums', 'php_bbposts', 'php_bbtopics', 'php_bbusers');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('php_bbcaptcha_questions', 'php_bbcaptcha_answers', 'php_bbqa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'php_bbext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'php_bblog');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'php_bbmigrations', './../', 'php', 'php_bb', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'php_bbmodules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'php_bbmodules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'php_bbnotification_types', 'php_bbnotifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'php_bbuser_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'php_bbnotification_types', 'php_bbuser_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'php_bbprofile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'php_bbprofile_fields', 'php_bbprofile_lang', 'php_bbprofile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000751558cf000000000a610724(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'php_bbbbcodes', 'php_bbsmilies', 'php_bbstyles', 'php_bbwords', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'php_bbforums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'php_bbforums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'php_bbgroups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'php_bbprivmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'php_bbtopics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'php_bbposts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'php_bbusers');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'php_bbusers');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'php_bbacl_groups',
            'tables.acl_options' => 'php_bbacl_options',
            'tables.acl_roles' => 'php_bbacl_roles',
            'tables.acl_roles_data' => 'php_bbacl_roles_data',
            'tables.acl_users' => 'php_bbacl_users',
            'tables.attachments' => 'php_bbattachments',
            'tables.auth_provider_oauth_token_storage' => 'php_bboauth_tokens',
            'tables.auth_provider_oauth_states' => 'php_bboauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'php_bboauth_accounts',
            'tables.banlist' => 'php_bbbanlist',
            'tables.bbcodes' => 'php_bbbbcodes',
            'tables.bookmarks' => 'php_bbbookmarks',
            'tables.bots' => 'php_bbbots',
            'tables.captcha_qa_questions' => 'php_bbcaptcha_questions',
            'tables.captcha_qa_answers' => 'php_bbcaptcha_answers',
            'tables.captcha_qa_confirm' => 'php_bbqa_confirm',
            'tables.config' => 'php_bbconfig',
            'tables.config_text' => 'php_bbconfig_text',
            'tables.confirm' => 'php_bbconfirm',
            'tables.disallow' => 'php_bbdisallow',
            'tables.drafts' => 'php_bbdrafts',
            'tables.ext' => 'php_bbext',
            'tables.extensions' => 'php_bbextensions',
            'tables.extension_groups' => 'php_bbextension_groups',
            'tables.forums' => 'php_bbforums',
            'tables.forums_access' => 'php_bbforums_access',
            'tables.forums_track' => 'php_bbforums_track',
            'tables.forums_watch' => 'php_bbforums_watch',
            'tables.groups' => 'php_bbgroups',
            'tables.icons' => 'php_bbicons',
            'tables.lang' => 'php_bblang',
            'tables.log' => 'php_bblog',
            'tables.login_attempts' => 'php_bblogin_attempts',
            'tables.migrations' => 'php_bbmigrations',
            'tables.moderator_cache' => 'php_bbmoderator_cache',
            'tables.modules' => 'php_bbmodules',
            'tables.notification_types' => 'php_bbnotification_types',
            'tables.notifications' => 'php_bbnotifications',
            'tables.poll_options' => 'php_bbpoll_options',
            'tables.poll_votes' => 'php_bbpoll_votes',
            'tables.posts' => 'php_bbposts',
            'tables.privmsgs' => 'php_bbprivmsgs',
            'tables.privmsgs_folder' => 'php_bbprivmsgs_folder',
            'tables.privmsgs_rules' => 'php_bbprivmsgs_rules',
            'tables.privmsgs_to' => 'php_bbprivmsgs_to',
            'tables.profile_fields' => 'php_bbprofile_fields',
            'tables.profile_fields_data' => 'php_bbprofile_fields_data',
            'tables.profile_fields_options_language' => 'php_bbprofile_fields_lang',
            'tables.profile_fields_language' => 'php_bbprofile_lang',
            'tables.ranks' => 'php_bbranks',
            'tables.reports' => 'php_bbreports',
            'tables.reports_reasons' => 'php_bbreports_reasons',
            'tables.search_results' => 'php_bbsearch_results',
            'tables.search_wordlist' => 'php_bbsearch_wordlist',
            'tables.search_wordmatch' => 'php_bbsearch_wordmatch',
            'tables.sessions' => 'php_bbsessions',
            'tables.sessions_keys' => 'php_bbsessions_keys',
            'tables.sitelist' => 'php_bbsitelist',
            'tables.smilies' => 'php_bbsmilies',
            'tables.sphinx' => 'php_bbsphinx',
            'tables.styles' => 'php_bbstyles',
            'tables.styles_template' => 'php_bbstyles_template',
            'tables.styles_template_data' => 'php_bbstyles_template_data',
            'tables.styles_theme' => 'php_bbstyles_theme',
            'tables.styles_imageset' => 'php_bbstyles_imageset',
            'tables.styles_imageset_data' => 'php_bbstyles_imageset_data',
            'tables.teampage' => 'php_bbteampage',
            'tables.topics' => 'php_bbtopics',
            'tables.topics_posted' => 'php_bbtopics_posted',
            'tables.topics_track' => 'php_bbtopics_track',
            'tables.topics_watch' => 'php_bbtopics_watch',
            'tables.user_group' => 'php_bbuser_group',
            'tables.user_notifications' => 'php_bbuser_notifications',
            'tables.users' => 'php_bbusers',
            'tables.warnings' => 'php_bbwarnings',
            'tables.words' => 'php_bbwords',
            'tables.zebra' => 'php_bbzebra',
...
class phpbbtemplatetwiglexer_00000000751558cf000000000a610724 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a15acb7ef34c893253002 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a15acb7ef35e541336316 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a15acb7ef31c199591940 = array(
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, 'set_environment', array('env' => $env), $this->initializer5a15acb7ef35e541336316);

        return $this->valueHolder5a15acb7ef34c893253002->set_environment($env);
    }
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a15acb7ef35e541336316);

        return $this->valueHolder5a15acb7ef34c893253002->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a15acb7ef35e541336316);

        return $this->valueHolder5a15acb7ef34c893253002->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a15acb7ef35e541336316 = $initializer;
    }
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__get', array('name' => $name), $this->initializer5a15acb7ef35e541336316);

        if (isset(self::$publicProperties5a15acb7ef31c199591940[$name])) {
            return $this->valueHolder5a15acb7ef34c893253002->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a15acb7ef34c893253002;
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a15acb7ef35e541336316);
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__isset', array('name' => $name), $this->initializer5a15acb7ef35e541336316);
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__unset', array('name' => $name), $this->initializer5a15acb7ef35e541336316);
    ...
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__clone', array(), $this->initializer5a15acb7ef35e541336316);

        $this->valueHolder5a15acb7ef34c893253002 = clone $this->valueHolder5a15acb7ef34c893253002;
    }

    public function __sleep()
    {
        $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, '__sleep', array(), $this->initializer5a15acb7ef35e541336316);

        return array('valueHolder5a15acb7ef34c893253002');
    }
    ...
    {
        return $this->initializer5a15acb7ef35e541336316;
    }
    ...
    {
        return $this->initializer5a15acb7ef35e541336316 && $this->initializer5a15acb7ef35e541336316->__invoke($this->valueHolder5a15acb7ef34c893253002, $this, 'initializeProxy', array(), $this->initializer5a15acb7ef35e541336316);
    }
    ...
    {
        return null !== $this->valueHolder5a15acb7ef34c893253002;
    }
    ...
    {
        return $this->valueHolder5a15acb7ef34c893253002;
    }
