...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006b9dfbbe00000000461a1b0f(
...
class phpbbtemplatetwiglexer_000000006b9dfbbe00000000461a1b0f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a15acbae7db9542759274 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a15acbae7dd4958496711 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a15acbae7d78995015340 = array(
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, 'set_environment', array('env' => $env), $this->initializer5a15acbae7dd4958496711);

        return $this->valueHolder5a15acbae7db9542759274->set_environment($env);
    }
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a15acbae7dd4958496711);

        return $this->valueHolder5a15acbae7db9542759274->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a15acbae7dd4958496711);

        return $this->valueHolder5a15acbae7db9542759274->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a15acbae7dd4958496711 = $initializer;
    }
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__get', array('name' => $name), $this->initializer5a15acbae7dd4958496711);

        if (isset(self::$publicProperties5a15acbae7d78995015340[$name])) {
            return $this->valueHolder5a15acbae7db9542759274->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a15acbae7db9542759274;
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a15acbae7dd4958496711);
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__isset', array('name' => $name), $this->initializer5a15acbae7dd4958496711);
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__unset', array('name' => $name), $this->initializer5a15acbae7dd4958496711);
    ...
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__clone', array(), $this->initializer5a15acbae7dd4958496711);

        $this->valueHolder5a15acbae7db9542759274 = clone $this->valueHolder5a15acbae7db9542759274;
    }

    public function __sleep()
    {
        $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, '__sleep', array(), $this->initializer5a15acbae7dd4958496711);

        return array('valueHolder5a15acbae7db9542759274');
    }
    ...
    {
        return $this->initializer5a15acbae7dd4958496711;
    }
    ...
    {
        return $this->initializer5a15acbae7dd4958496711 && $this->initializer5a15acbae7dd4958496711->__invoke($this->valueHolder5a15acbae7db9542759274, $this, 'initializeProxy', array(), $this->initializer5a15acbae7dd4958496711);
    }
    ...
    {
        return null !== $this->valueHolder5a15acbae7db9542759274;
    }
    ...
    {
        return $this->valueHolder5a15acbae7db9542759274;
    }
